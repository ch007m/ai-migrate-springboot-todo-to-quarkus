...
// REMOVED: @Controller — not supported by quarkus-spring-web (only @RestController).
// Migrated to JAX-RS @Path resource with Qute @CheckedTemplate for HTML rendering.
@Path("/")
public class TaskController {
    ...
    public static class Templates {
        public static native TemplateInstance home(Task task, boolean noTasks,
                int currentPage, int totalPages, long totalItems, List<Task> tasks);
    ...
    public Object findPaginated(@PathParam("pageNo") int pageNo) {
        ...
        if (tasks.isEmpty()) {
            ...
            return Templates.home(new Task(), false,
                    pageNo, page.getTotalPages(), page.getTotalElements(), tasks);
        }
    }
